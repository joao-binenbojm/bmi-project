    ...
    methods
        ...
        function [out,obj] = predict(obj,testData)
            ...
            if pred_1 == 1 % left(1): 1, 2, 7, 8
                ...
                if pred_2 == 1 % 1 (1) - 2 (0)
                    %pred_3 = obj.svmPredict(model.model3_1_2, fr_avg(1,:));
                    pred_3 = predict(obj.model.LDA_1_2, fr_avg(1,:));
                    if pred_3 == 1
                        obj.pred_angle = 1;
                    else 
                        obj.pred_angle = 2;
                ...
                elseif pred_2 == 0 % 7 (1) - 8 (0)
                    %pred_3 = obj.svmPredict(model.model3_7_8, fr_avg(1,:));
                    pred_3 = predict(obj.model.LDA_7_8, fr_avg(1,:));
                    if pred_3 == 1 
                        obj.pred_angle = 7;
                    else
                        obj.pred_angle = 8;
            ...
            elseif pred_1 == 0 % right(0): 3, 4, 5, 6 
                ...
                if pred_2 == 1 % 3 (1) - 4 (0)
                    %pred_3 = obj.svmPredict(model.model3_3_4, fr_avg(1,:));
                    pred_3 = predict(obj.model.LDA_3_4, fr_avg(1,:));
                    if pred_3 == 1
                        obj.pred_angle = 3;
                    else 
                        obj.pred_angle = 4;
                ...
                elseif pred_2 == 0 % 5 (1) - 6 (0)
                    %pred_3 = obj.svmPredict(model.model3_5_6, fr_avg(1,:)); 
                    pred_3 = predict(obj.model.LDA_5_6, fr_avg(1,:)); 
                    if pred_3 == 1 
                        obj.pred_angle = 5;
                    else
                        obj.pred_angle = 6;
